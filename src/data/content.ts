...
export const SERVICE_CATEGORIES = [
  {
    ...
    items: [
      ...
      'Scheduling and coordination for medical appointments and transportation',
      ...
      "Call light device available in each resident's room.",
  ...
  },
  {
    ...
    items: [
      ...
      'Family room with books, music, and quiet reading',
